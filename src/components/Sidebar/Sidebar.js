    ...
    <div className="wrapper">
      <nav id="sidebar">
        <ul className="play-list">
          <li className="active">
            <a className="link-header" href="index.html">
              Home
            </a>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Not intended for commercial use. Made this for fun as a side
              project using React
            </p>
            <p>
              Copyright- 2019 - All Video Game information obtained from RAWG
            </p>
          </li>
        </ul>
      </nav>
